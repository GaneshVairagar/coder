    ...
    <div className='bg-[#121212] pt-[4rem] md:pt-[8rem] pb-[5rem] '>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 w-[80%] mx-auto items-center gap-[3rem] mt-[4rem] text-white'>
            <div data-aos="fade-right" >
                <div className="
                h-[75vh] bg-[url('/images/b1.jpg')] mt-[5vh] bg-cover bg-center
                hover:scale-110 transform transition-all duration-300 hover:-rotate-6 uppercase
            ...
            <div data-aos="zoom-in" data-aos-delay="300">
                <div className="
                h-[75vh] bg-[url('/images/b2.jpg')] mt-[5vh] bg-cover bg-center
                hover:scale-110 transform transition-all duration-300  uppercase
                font-semibold text-center p-[2rem]">
